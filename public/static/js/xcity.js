$.fn.xcity = function(pName,cName,aName){
    ...
    this.showP  = function(provinceList) {
        ...
        this.p.html("<option selected value=''>请选择省</option>");
...
{name:'深圳市', areaList:['市辖区','罗湖区','福田区','南山区','宝安区','龙岗区','盐田区','龙华新区','光明新区','坪山新区','大鹏新区']},		   
...
{name:'东莞市', areaList:['石碣','石龙','茶山','石排','企石','横沥','桥头','谢岗','东坑','常平','寮步','大朗','黄江','清溪','塘厦','凤岗','长安','虎门','厚街','沙田','道窖','洪梅','麻涌','中堂','高步','樟木头','大岭山','望牛墩']},		   
